...
let uni = []
let filter = universities.filter((university) => university.includes("Uni"));
uni.push(filter)
console.log(uni)
...
populationTotal = zooAnimals.reduce(function(totalVal, zooAnimals) {
  return totalVal + zooAnimals.population;
}, 0);
